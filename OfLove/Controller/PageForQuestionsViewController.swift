...
//
  ...
  func hidingButtonBack() {
    if questionLabel.text == ofLoveData.listOfQuestions[indexZero] {
  ...
  @IBAction func nextButton(_ sender: UIButton) {
    ...
    questionLabel.text = ofLoveData.listOfQuestions[currentQuestionIndex]
    questionNumberLabel.text = ofLoveData.questionNumber[currentQuestionNumberIndex]
    
    // Изменяется текст кнопки
    if currentQuestionIndex == ofLoveData.listOfQuestions.index(before: 36) {
  ...
  // Проверяем, достигли ли конца массива после увеличения индекса
    if currentQuestionIndex >= ofLoveData.listOfQuestions.count {
  ...
  @IBAction func backButton(_ sender: UIButton) {
    ...
    questionLabel.text = ofLoveData.listOfQuestions[currentQuestionIndex - 1]
    questionNumberLabel.text = ofLoveData.questionNumber[currentQuestionNumberIndex - 1]
